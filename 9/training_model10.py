...
MAX_CLASSES = 100
MODEL_PATH = "asl_seq_model_smart_v3_updated.keras"
HISTORY_PATH = "history_seq_smart_v3_updated.json"
TEST_JSON_PATH = "test_metrics_v3.json"
TEST_PLOT_PATH = "test_graphs_v3.png"
...
plt.tight_layout()
plt.savefig("training_graphs_v3_updated.png")
plt.show()
print("[INFO] Training graphs saved to training_graphs_v3_updated.png")
...
# Plot test graph (single bar for simplicity)
