...
# -------- CONFIG --------
SEQUENCES_DIR = r"C:\Users\garga\Documents\Maturarbeit\ASL_Citizen\ASL_Citizen\dataset_full"
FRAMES_PER_CLIP = 5
IMG_SIZE = (112, 112)
BATCH_SIZE = 8
EPOCHS = 6
FRACTION = 0.15             # use 15% of data for faster test
MAX_CLASSES = 200           # limit to first 200 classes
...
def load_sequences(split="train", class_names=None, max_classes=None):
    ...
    print(f"[INFO] Loaded {len(X)} sequences for {split} split.")
