# training_model15.py
# Simplified + corrected MobileNetV2 + BiLSTM small-scale training script
# Includes proper MobileNetV2 preprocessing, same two-phase training logic.
...
# -------- CONFIG --------
SEQUENCES_DIR = r"C:\Users\garga\Documents\Maturarbeit\ASL_Citizen\ASL_Citizen\sequences_small"
FRAMES_PER_CLIP = 12
IMG_SIZE = (96, 96)
BATCH_SIZE = 32
EPOCHS = 15
...
MODEL_BASE_PATH = "asl_seq_model15"
HISTORY_BASE_PATH = "history_seq15"
CV_SUMMARY_PATH = "cv_summary_mobilenet15.json"
TEST_JSON_PATH = "test15.json"
TEST_BAR_PLOT = "test_bar_graph15.png"
...
# Get class info early for dataset helpers
...
print(f"[INFO] Loaded {len(clip_paths_all)} clips across {num_classes} classes from {SEQUENCES_DIR}")
...
if hist:
    ...
    plt.tight_layout()
    plt.savefig("training_graphs15.png")
    plt.show()
    print("[INFO] Training graphs saved to training_graphs15.png")
else:
