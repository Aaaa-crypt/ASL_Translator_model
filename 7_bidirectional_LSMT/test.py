...
# ---------------- CONFIG ----------------
SEQUENCES_DIR = r"C:\Users\garga\Documents\Maturarbeit\ASL_Citizen\ASL_Citizen\sequences_small\test"
TEST_DIR = os.path.join(SEQUENCES_DIR, "test")
MODEL_PATH = r"C:\Users\garga\Documents\Maturarbeit\7_bidirectional_LSMT\asl_seq_model_smart_v3.keras"
